...
function sendOtp($db, $username, $email) {
    ...
    // DB তে OTP সেভ কর
    mysqli_query($db, "INSERT INTO `verify` (username, email, otp) VALUES('$username','$email','$otp')");
    ...
    <body style='font-family: Arial, sans-serif; color: #333;'>
      ...
      <p>🔐 <b>Your One-Time Password (OTP) for Account Activation</b> is:</p>
    ...
    $headers .= "From: Online Library <no-reply@yourdomain.com>" . "\r\n";
